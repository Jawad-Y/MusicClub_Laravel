                      ...
                      >
                            ...
                            <div className="space-y-1 flex-1">
                              ...
                              <CardDescription>
                                <div className="flex items-center gap-1 mt-1">
                                  ...
                                  Session: {new Date(homework.session?.date || "").toLocaleDateString()}
                                </div>
                                {homework.due_date && (
                        ...
                        <CardContent>
                          <div className="space-y-3">
                            <p className="text-sm text-foreground">{homework.description}</p>
                            <div className="flex items-center justify-between text-xs text-muted-foreground">
                              ...
                              >
                                {homework.assign_scope === "class" ? "Class Assignment" : "Individual"}
                              </span>
                              <span>
