...
function ClassDetailsPage() {
    ...
    const fetchMembers = async ()=>{
        try {
            ...
            if (response.success && response.data) {
                const classMembers = response.data.filter((m)=>m.class_id === classId);
    ...
    const fetchTrainingSessions = async ()=>{
        try {
            ...
            if (response.success && response.data) {
                const classSessions = response.data.filter((s)=>s.class_id === classId);
...
_s(ClassDetailsPage, "KButAaNr7vR3YbJBUwn6o36yR1s=", false, function() {
    return [
...
//# sourceMappingURL=music-club-frontend%20%282%29_be71058f._.js.map