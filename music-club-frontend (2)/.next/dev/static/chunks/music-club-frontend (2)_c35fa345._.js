                ...
                "DashboardPage.useEffect.fetchStats": async ()=>{
                    try {
                        ...
                        const [usersRes, classesRes, instrumentsRes, sessionsRes, eventsRes] = results.map({
                            "DashboardPage.useEffect.fetchStats": (result)=>result.status === 'fulfilled' ? result.value : {
                                    success: false,
                                    data: []
                                }
                        ...
                        results.forEach({
                            "DashboardPage.useEffect.fetchStats": (result, index)=>{
...
_s(DashboardPage, "0rXkOcDGvC+ANEd/xdHSd3pHm5A=", false, function() {
    return [
...
//# sourceMappingURL=music-club-frontend%20%282%29_c35fa345._.js.map