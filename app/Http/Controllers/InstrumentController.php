...
class InstrumentController extends Controller
{
    ...
    //hon fih errors , lezm n3ml import
    
    public function exportExcel()
    {
        $columns = ['id','name','serial_number','instrument_type_id','condition','availability','description','created_at','updated_at'];
        $headings = ['ID','Name','Serial Number','Instrument Type ID','Condition','Availability','Description','Created At','Updated At'];

        return Excel::download(new Export(Instrument::query(), $columns, $headings), 'instruments.xlsx');
    ...
    public function exportCsv()
    {
        ...
        return Excel::download(new Export(Instrument::query(), $columns, $headings), 'instruments.csv', \Maatwebsite\Excel\Excel::CSV);
    }
}
